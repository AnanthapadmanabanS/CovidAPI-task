...
async function foo() {
    ...
    var result=res1[index].Recovered;
    document.getElementById("recovered").innerText=`Total Recovered Cases : ${result}`;


    var result=res1[index].Deaths;
    document.getElementById("deaths").innerText=`Total Deaths Cases : ${result}`;
}